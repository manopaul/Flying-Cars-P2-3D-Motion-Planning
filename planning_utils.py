...
def get_lat_lon(filename):
    """
    Reads the latitude and longitude from the first line of the filename
    ...
    with open(filename) as f:
        latLongCoords = f.readline() # Latitude and Longitude are in the first line of the collider file
        lat0, lon0 = latLongCoords.split(',')
        lat, lon = float(lat0.split(' ')[-1]), float(lon0.split(' ')[-1])
    return (lat, lon)
